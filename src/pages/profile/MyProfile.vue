...
<template>
  <div
    class="min-h-screen bg-white dark:bg-black flex flex-col justify-between pb-20 transition-colors duration-300"
  >
    <!-- Profile -->
      ...
      <div class="px-6">
        ...
        <router-link to="/conditions">
          ...
          >
            <div class="flex items-center gap-4">
              ...
              >
                <i
                  class="fa-regular fa-file-lines text-2xl text-gray-600 dark:text-gray-300"
                ></i>
              </div>
              <span
                class="text-base font-medium text-gray-800 dark:text-gray-200"
        ...
        <router-link to="/privacy">
          ...
          >
            <div class="flex items-center gap-4">
              ...
              >
                <i
                  class="fa-solid fa-shield-halved text-2xl text-gray-600 dark:text-gray-300"
                ></i>
              </div>
              <span
                class="text-base font-medium text-gray-800 dark:text-gray-200"
        ...
        >
          ...
          <label class="relative inline-flex items-center cursor-pointer">
            ...
            <div
              class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-500 dark:peer-focus:ring-blue-300 rounded-full peer dark:bg-gray-700 peer-checked:bg-blue-500 transition-all"
            ></div>
            <div
