...
<template>
  <div class="min-h-screen justify-between bg-gray-50 overflow-y-auto pb-28">
    <!-- Header -->
  ...
  selectedDate.value === index
      ...
      <div class="flex gap-4">
        ...
        <div class="bg-white w-40 p-4 rounded-2xl shadow-sm">
          <div class="flex items-center gap-2 mb-2">
             <div class="bg-blue-100 h-8 w-8 flex justify-center items-center rounded-md">
    ...
    <div class="p-5">
      ...
      <div
        class="w-full max-w-md rounded-lg relative px-5 py-3 shadow-md overflow-hidden select-none"
        :class="
        isCheckedIn
      ...
      >
        <!-- Ikon geser -->
        <div
        class="absolute inset-y-1 left-3 flex items-center justify-center bg-white w-10 h-10 rounded-lg shadow cursor-grab transition-transform duration-100"
