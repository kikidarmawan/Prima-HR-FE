    ...
    <div class="space-y-4 mt-6">
      ...
      <div class="space-y-4">
        ...
        <div class="relative">
          ...
          />
          <label
            class="absolute left-4 -top-2 bg-white px-1 text-xs text-blue-600 z-10 pointer-events-none transition-all duration-200 peer-placeholder-shown:top-2 peer-placeholder-shown:text-sm peer-placeholder-shown:text-gray-400 peer-focus:-top-2 peer-focus:text-xs peer-focus:text-blue-600"
          >
            Enter New Password
          </label>
          <button
