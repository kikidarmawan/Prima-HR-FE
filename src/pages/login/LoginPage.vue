  ...
  <div class="min-h-screen flex justify-center bg-white px-4">
    <div class="w-full max-w-sm m-5">
      ...
      <p class="text-start text-2xl font-bold">
        To <span class="text-blue-600 font-bold">PRIMA HR</span>
      </p>
      <p class="text-start text-sm text-gray-400 mb-6">
      ...
      <form>
        ...
        <div class="mb-4 relative">
          <input
            type="email"
            placeholder=" "
            class="w-full border border-blue-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 peer"
          />
          <label
        ...
        <div class="mb-4 relative">
          ...
          <button
            ...
            class="absolute cursor-pointer right-3 top-2.5 text-gray-500"
          >
            <Icon
