    ...
    <div
      ...
      <div class="flex justify-between items-center w-full">
        ...
        <div class="flex gap-15.5 items-center pl-2">
         <router-link to="/home">
          <i
              class="fa-solid fa-house text-gray-500 text-xl hover:text-blue-600 transition-colors cursor-pointer"></i>
         </router-link>
          <router-link to="/leaves">
             <i
              class="fa-regular fa-calendar text-xl text-gray-500 hover:text-blue-600 transition-colors cursor-pointer"></i>
          </router-link>
        </div>
        ...
        <div class="flex gap-15.5 items-center pr-2">
          <router-link to="/holiday">
             <i
              class="fa-solid fa-umbrella-beach text-xl text-gray-500 hover:text-blue-600 transition-colors cursor-pointer"></i>
          </router-link>
          <router-link to="/profile">
            <i
              class="fa-regular fa-user text-xl text-gray-500 hover:text-blue-600 transition-colors cursor-pointer"></i>
          </router-link>
        </div>
      </div>
    </div>
